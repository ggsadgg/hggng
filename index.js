...
let owners = '976534298062639106'// ايدي الي هيتحول له كريديت
let owner;
const
  updateAdmins = () => {
  owner = db.get("admins")
  owners = '976534298062639106'
  owner.unshift('976534298062639106')//اي دي المالك
}
updateAdmins()
let sv = '998963110406787235' //حط ايدي سيرفر   
...
client.on('guildCreate', guild => {
  ...
  let textList = ["DeXTeR" , `${prefix}help` , "BY DeXTeR"] 
    ...
    if (command === "buy") {
      ...
      let buys = new Discord.MessageEmbed()
        ...
        .addField(`**Purchasing ${account} account :**`
          ...
          \`\`\`
#credits <@${owners}> ${numOfAcc * tax} 
                  or 
#credits @DeXTeR ${numOfAcc * tax}
           \`\`\`
